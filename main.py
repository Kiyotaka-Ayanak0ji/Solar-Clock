...
def main():
    ...
    while True:
        ...
        for key in months_to_days.keys():
            ...
            pygame.draw.aaline(screen, (255, 255, 255), posA, posB, 3)
            posTxt = cf.get_position(CENTER, 230, face_angle)
            draw_text(key, 22, posTxt, (255, 255, 255), "Comfortaa-Regular.ttf")
        ...
        # Draw Text Block.
        draw_text(f"DAY: {count:0>3}", 64, (4 * WIDTH // 5, 2 * HEIGHT // 5), (255, 255, 255), "Comfortaa-Regular.ttf")
        draw_text(f"{points[count]:.3f}", 48, (4 * WIDTH // 5, 4 * HEIGHT // 7), (255, 255, 255), "Comfortaa-Regular.ttf")
        draw_text(f"million km", 30, (4 * WIDTH // 5, 4 * HEIGHT // 7 + 50), (255, 255, 255), "Comfortaa-Regular.ttf")
